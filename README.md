...
```groovy
jooq {
  version = '3.20.2'  // the default (can be omitted)
...
```kotlin
jooq {
  version.set("3.20.2")  // the default (can be omitted)
...
be seen on the jOOQ generation tool's [Configuration](https://github.com/jOOQ/jOOQ/blob/version-3.20.2/jOOQ-meta/src/main/java/org/jooq/meta/jaxb/Configuration.java) class, or
...
jooq {
    version = '3.20.2'  // default (can be omitted)
